...
import (
	...
	"github.com/statictoad/vtc-platform/internal/client"
...
func main() {
	...
	svc := client.NewService(repo, publisher)
	handler := client.NewHandler(svc)
	...
	go func() {
		slog.Info("client-api starting", "port", port)
